...
def generate_monthly_pdf(df, current_month, previous_month) -> bytes:
    ...
    story.append(Paragraph("Cost per usage is an indicator only and may include blended charges, fees, or adjustments; it should not be interpreted as an exact utility rate.", small))
