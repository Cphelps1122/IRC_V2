...
page_header("Monthly Summary Report", "One-page leadership overview with PDF export. Summary only; no raw data export included.")
...
with col_b:
    panel_start("Utility Breakdown", "Cost per usage is an indicator, not an exact rate. Units are kept separate by utility.")
